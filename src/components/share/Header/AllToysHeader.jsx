          ...
          <div className="relative flex items-center justify-between">
            <div className="lg:w-1/2">
              ...
              >
                ...
                <input
                  type="text"
                  className="w-1/3 py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
                  placeholder="Search"
                />
              </Link>
            </div>

            <div className="lg:w-1/2 lg:flex lg:items-center lg:gap-2">
              <div>
