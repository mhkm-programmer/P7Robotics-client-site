...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 bg-gray-900 px-4 py-5  mx-auto">
      <div className="max-w-lg sm:mx-auto sm:text-center pt-12">
        <img
          src="https://i.ibb.co/D81xd1N/logo-Transparent.png"
        ...
        <p className="p hover:text-white">
          ...
          <ul>
            ...
            <li>Email: info@p7robotics.com</li>
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0 hover:text-white">
          &copy; 2023 P7 Robotics Co. Ltd, All rights reserved.
        </div>
